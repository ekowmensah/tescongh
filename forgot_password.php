            ...
            if ($result['success']) {
                ...
                if (!empty($result['phone'])) {
                    try {
                        ...
                        // Optimized SMS message for cost-effectiveness
                        $message = "Password Reset Request\n"
                                 . $resetLink . "\n"
                                 . "Expires in 1hr. Ignore if u didn't request.";
                ...
                if ($emailSent || $smsSent) {
                    if (count($deliveryMethods) > 0) {
                        ...
                        $success = "Password reset instructions have been sent to your {$methodsText}.";
                    }
                } else {
